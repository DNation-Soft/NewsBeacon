...
class Cart extends BaseController {
    ...
    public function addToCart(){
        ...
        $name = get_data_by_id('name','nb_products','product_id',$product_id);
        $price = get_data_by_id('price','nb_products','product_id',$product_id);
    ...
    public function addtocartdetail(){
        ...
        foreach(get_all_data_array('nb_option') as $v) {
