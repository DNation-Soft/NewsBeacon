...
class User extends BaseController
{
    ...
    public function create_action()
    {
        ...
        if ($this->validation->run($data) == FALSE) {
            ...
            $check = is_exists('nb_users','email',$data['email']);
            if ($check == true) {
    ...
    public function update_action()
    {
        ...
        if ($this->validation->run($data) == FALSE) {
            ...
            $check = is_exists_update('nb_users','email',$data['email'],'user_id',$user_id);
            if ($check == true) {
                $table = DB()->table('nb_users');
    ...
    public function image_action(){
        ...
        if (!empty($_FILES['pic']['name'])) {
            ...
            //old image unlink
            $old_img = get_data_by_id('pic', 'nb_users', 'user_id', $user_id);
            if (!empty($old_img)) {
