...
class Album extends BaseController
{
    ...
    public function create_action()
    {
        ...
        if ($this->validation->run($data) == FALSE) {
            ...
            //image size array
            $this->imageProcessing->sizeArray = [ ['width'=>'420', 'height'=>'420', ], ['width'=>'254', 'height'=>'254', ],  ['width'=>'50', 'height'=>'50', ],['width'=>'198', 'height'=>'198', ],];
            ...
            if($this->request->getFileMultiple('multiImage')){
                ...
                foreach ($files as $file) {
                    ...
                    if ($file->isValid() && ! $file->hasMoved())
                    {
                        ...
                        $albumImgTable = DB()->table('nb_album_details');
                        ...
                        $proImgUpTable = DB()->table('nb_album_details');
    ...
    public function update($album_id)
    {
        ...
        if (!isset($isLoggedInEcAdmin) || $isLoggedInEcAdmin != TRUE) {
            ...
            $tableAl = DB()->table('nb_album_details');
    ...
    public function update_action()
    {
        ...
        if ($this->validation->run($data) == FALSE) {
            ...
            if (!empty($_FILES['thumb']['name'])) {
                ...
                //unlink
                $oldImg = get_data_by_id('thumb','nb_album','album_id',$album_id);
                $pic = $this->request->getFile('thumb');
            ...
            if($this->request->getFileMultiple('multiImage')){
                ...
                foreach ($files as $key => $file) {
                    ...
                    if ($file->isValid() && ! $file->hasMoved())
                    {
                        ...
                        $proImgTable = DB()->table('nb_album_details');
    ...
    public function delete($album_id){
        ...
        $tableDetail = DB()->table('nb_album_details');
    ...
    public function album_image_sort_action(){
        ...
        $table = DB()->table('nb_album_details');
