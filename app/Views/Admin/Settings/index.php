                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-four-footer-social" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label><?php echo $settingsTitle['messenger'];?></label>
                                                    <input type="text" name="messenger" class="form-control" value="<?php echo $settings['messenger'];?>"  required>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label><?php echo $settingsTitle['whatsapp'];?></label>
                                                    <input type="text" name="whatsapp" class="form-control" value="<?php echo $settings['whatsapp'];?>"  required>
                                                </div>
